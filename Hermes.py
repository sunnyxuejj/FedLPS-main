...
class Client:
    ...
    def train(self, w_server, round, lr=None):
        ...
        train_flops = len(self.traindata_loader) * count_training_flops(copy.deepcopy(self.local_net), self.args,
...
if __name__ == "__main__":
    ...
    for round in range(args.rounds):
        ...
        print("test loss: {:.5f}, test accuracy: {:.5f}".format(round, sum(glob_test_loss) / len(glob_test_loss),
